...
source="/Users/dlosardo/Documents/workspace/Dissertation" #where source files are located
source(paste(source,"/functions.R",sep=""))
outputDiri="/Users/dlosardo/Documents/workspace/Dissertation/simResults" #where SAS outputs results and I keep results
...
#file = paste(outputDiri,"/correctNull/MPFAnonsICT_deJongICF_ALL.dat",sep="")
